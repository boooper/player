        ...
        .invoke_handler({
            #[cfg(desktop)]
            {
                tauri::generate_handler![
                    ...
                    commands::health::test_profile_connection,
                    // last.fm
                    ...
                    commands::playback::playback_set_normalization,
                    commands::playback::playback_set_normalization_mode,
                    commands::playback::playback_set_loudness_compensation,
            ...
            #[cfg(mobile)]
            {
                tauri::generate_handler![
                    ...
                    commands::library::library_delete_playlist,
                    commands::library::library_materialize_song,
                    // lyrics (musixmatch only on mobile; genius requires desktop)
                    commands::lyrics::fetch_lyrics,
                    // playback (cpal supports Android AAudio and iOS CoreAudio)
                    commands::playback::playback_load,
                    commands::playback::playback_preload,
                    commands::playback::playback_play,
                    commands::playback::playback_pause,
